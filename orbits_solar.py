...
if __name__ == "__main__":
    ...
    res13 = engine.predict_orbits_v13(vals)
    print("=" * 72)
    print("TESTE ORBITS TGE-13.0 (ToE ALTA PRECISÃO)")
    print(f"Erro Médio Global: {res13['erro_medio_global']:.2f}%")
    for r in res13["tabela"]:
        print(f"{r['planeta']:<10} | Real: {r['real_ua']:<7.4f} UA | TGE-13: {r['tge_ua']:<7.4f} UA | Erro: {r['erro_rel_pct']:.2f}%")
    print("=" * 72)
